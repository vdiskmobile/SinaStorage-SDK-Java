 ...
 */
public class LegacyS3ProgressListener implements com.sina.event.ProgressListener {
    ...
    @SuppressWarnings("deprecation")
    public void progressChanged(com.sina.event.ProgressEvent progressEvent) {
        if (listener == null) return;
        listener.progressChanged(transform(progressEvent));
    }

    @SuppressWarnings("deprecation")
    private ProgressEvent transform(com.sina.event.ProgressEvent event) {
