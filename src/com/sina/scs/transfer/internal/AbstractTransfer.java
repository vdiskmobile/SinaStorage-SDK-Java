...
import com.sina.scs.model.LegacyS3ProgressListener;
import com.sina.scs.transfer.Transfer;
...
public abstract class AbstractTransfer implements Transfer {
     ...
     */
    @Deprecated
    AbstractTransfer(String description, TransferProgress transferProgress, com.sina.scs.transfer.internal.ProgressListenerChain progressListenerChain) {
        this(description, transferProgress, progressListenerChain, null);
    }
    ...
    @Deprecated
    AbstractTransfer(String description, TransferProgress transferProgress,
            com.sina.scs.transfer.internal.ProgressListenerChain progressListenerChain, TransferStateChangeListener stateChangeListener) {
     ...
     */
    @Deprecated
    public synchronized void addProgressListener(com.sina.scs.model.ProgressListener listener) {
     ...
     */
    @Deprecated
    public synchronized void removeProgressListener(com.sina.scs.model.ProgressListener listener) {
