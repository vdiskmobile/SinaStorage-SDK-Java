...
import com.sina.scs.transfer.MultipleFileUpload;
...
public class MultipleFileUploadImpl extends MultipleFileTransfer implements MultipleFileUpload {
    ...
    @Deprecated
    public MultipleFileUploadImpl(String description, TransferProgress transferProgress,
            com.sina.scs.transfer.internal.ProgressListenerChain progressListenerChain, String keyPrefix, String bucketName, Collection<? extends Upload> subTransfers) {
