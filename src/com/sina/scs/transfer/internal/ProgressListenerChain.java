...
import com.sina.scs.model.ProgressEvent;
import com.sina.scs.model.ProgressListener;
...
public class ProgressListenerChain implements ProgressListener {
    ...
    public com.sina.event.ProgressListenerChain transformToGeneralProgressListenerChain() {
        com.sina.event.ProgressListenerChain newProgressListenerChain = new com.sina.event.ProgressListenerChain();
        for ( ProgressListener listener : listeners ) {
