...
import com.sina.RequestClientOptions;
import com.sina.Response;
import com.sina.SCSClientException;
import com.sina.SCSServiceException;
import com.sina.SCSServiceException.ErrorType;
...
import com.sina.http.httpclientandroidlib.client.methods.HttpEntityEnclosingRequestBase;
import com.sina.http.httpclientandroidlib.client.methods.HttpRequestBase;
...
public class HttpConnect {
     ...
     */
    static final Log log = LogFactory.getLog("com.sina.request");
...
//            awsRequestMetrics.setCounter(Field.RequestCount, requestCount);
            ...
            com.sina.http.httpclientandroidlib.HttpResponse apacheResponse = null;
...
//                throw handleUnexpectedFailure(e, awsRequestMetrics);
    ...
    private void setUserAgent(Request<?> request) {
        ...
        if (awsreq != null) {
            ...
            if (opts != null) {
                String userAgentMarker = opts.getClientMarker(com.sina.RequestClientOptions.Marker.USER_AGENT);
...
//        }
    ...
    private boolean isRequestSuccessful(com.sina.http.httpclientandroidlib.HttpResponse response) {
     ...
     */
    private HttpResponse createResponse(HttpRequestBase method, Request<?> request, com.sina.http.httpclientandroidlib.HttpResponse apacheHttpResponse) throws IOException {
    ...
    private <T> T handleResponse(Request<?> request,
            ...
            com.sina.http.httpclientandroidlib.HttpResponse apacheHttpResponse,
            ExecutionContext executionContext) throws IOException
    {
        ...
        try {
//            com.sina.util.CountingInputStream countingInputStream = null;
...
//            throw e;
    ...
    private static boolean isTemporaryRedirect(com.sina.http.httpclientandroidlib.HttpResponse response) {
        int status = response.getStatusLine().getStatusCode();
    ...
    private SCSServiceException handleErrorResponse(Request<?> request,
            HttpResponseHandler<SCSServiceException> errorResponseHandler,
            HttpRequestBase method, com.sina.http.httpclientandroidlib.HttpResponse apacheHttpResponse) throws IOException {
...
//                                                           retries);
    ...
    private int parseClockSkewOffset(com.sina.http.httpclientandroidlib.HttpResponse response, SCSServiceException exception) {
