...
package com.sina.http.httpclientandroidlib.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.sina.http.httpclientandroidlib.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link com.sina.http.httpclientandroidlib.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link com.sina.http.httpclientandroidlib.auth.Credentials}.
     * <p>
     ...
     *  {@link com.sina.http.httpclientandroidlib.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link com.sina.http.httpclientandroidlib.auth.AuthScheme#getSchemeName()}.
     */
    public static final String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link com.sina.http.httpclientandroidlib.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
