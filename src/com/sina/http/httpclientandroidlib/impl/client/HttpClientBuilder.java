...
import com.sina.http.httpclientandroidlib.HttpResponseInterceptor;
...
import com.sina.http.httpclientandroidlib.client.BackoffManager;
import com.sina.http.httpclientandroidlib.client.ConnectionBackoffStrategy;
...
import com.sina.http.httpclientandroidlib.client.ServiceUnavailableRetryStrategy;
...
import com.sina.http.httpclientandroidlib.client.config.CookieSpecs;
import com.sina.http.httpclientandroidlib.client.config.RequestConfig;
import com.sina.http.httpclientandroidlib.client.protocol.RequestAcceptEncoding;
...
import com.sina.http.httpclientandroidlib.client.protocol.RequestExpectContinue;
import com.sina.http.httpclientandroidlib.client.protocol.ResponseContentEncoding;
...
import com.sina.http.httpclientandroidlib.config.RegistryBuilder;
...
import com.sina.http.httpclientandroidlib.conn.socket.PlainConnectionSocketFactory;
import com.sina.http.httpclientandroidlib.conn.ssl.SSLConnectionSocketFactory;
import com.sina.http.httpclientandroidlib.conn.ssl.SSLContexts;
import com.sina.http.httpclientandroidlib.conn.ssl.X509HostnameVerifier;
...
import com.sina.http.httpclientandroidlib.impl.NoConnectionReuseStrategy;
...
import com.sina.http.httpclientandroidlib.impl.conn.DefaultProxyRoutePlanner;
import com.sina.http.httpclientandroidlib.impl.conn.DefaultRoutePlanner;
import com.sina.http.httpclientandroidlib.impl.conn.DefaultSchemePortResolver;
import com.sina.http.httpclientandroidlib.impl.conn.PoolingHttpClientConnectionManager;
import com.sina.http.httpclientandroidlib.impl.conn.SystemDefaultRoutePlanner;
import com.sina.http.httpclientandroidlib.impl.cookie.BestMatchSpecFactory;
import com.sina.http.httpclientandroidlib.impl.cookie.BrowserCompatSpecFactory;
import com.sina.http.httpclientandroidlib.impl.cookie.IgnoreSpecFactory;
import com.sina.http.httpclientandroidlib.impl.cookie.NetscapeDraftSpecFactory;
import com.sina.http.httpclientandroidlib.impl.cookie.RFC2109SpecFactory;
import com.sina.http.httpclientandroidlib.impl.cookie.RFC2965SpecFactory;
import com.sina.http.httpclientandroidlib.impl.execchain.BackoffStrategyExec;
import com.sina.http.httpclientandroidlib.impl.execchain.ClientExecChain;
import com.sina.http.httpclientandroidlib.impl.execchain.MainClientExec;
import com.sina.http.httpclientandroidlib.impl.execchain.ProtocolExec;
import com.sina.http.httpclientandroidlib.impl.execchain.RedirectExec;
import com.sina.http.httpclientandroidlib.impl.execchain.RetryExec;
import com.sina.http.httpclientandroidlib.impl.execchain.ServiceUnavailableRetryExec;
import com.sina.http.httpclientandroidlib.protocol.HttpProcessor;
import com.sina.http.httpclientandroidlib.protocol.HttpProcessorBuilder;
...
import com.sina.http.httpclientandroidlib.util.TextUtils;
...
public class HttpClientBuilder {
     ...
     *   com.sina.http.httpclientandroidlib.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   com.sina.http.httpclientandroidlib.conn.socket.LayeredConnectionSocketFactory)} methods.
     */
     ...
     * <p/>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   com.sina.http.httpclientandroidlib.conn.HttpClientConnectionManager)} method.
     */
     ...
     * com.sina.http.httpclientandroidlib.protocol.HttpProcessor)} method.
     */
     ...
     *   com.sina.http.httpclientandroidlib.conn.routing.HttpRoutePlanner)} and
    ...
    /**
     * Assigns default {@link com.sina.http.httpclientandroidlib.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link com.sina.http.httpclientandroidlib.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     */
