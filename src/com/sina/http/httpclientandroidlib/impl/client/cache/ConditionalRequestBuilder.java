...
class ConditionalRequestBuilder {
     ...
     * to an {@link com.sina.http.httpclientandroidlib.HttpRequest} we will attempt to revalidate
     * the entry with the origin.  Build the origin {@link com.sina.http.httpclientandroidlib.HttpRequest}
     * here and return it.
     *
     ...
     * {@link com.sina.http.httpclientandroidlib.HttpRequest} we attempt to see if an existing
     * {@link HttpCacheEntry} is appropriate by building a conditional
     * {@link com.sina.http.httpclientandroidlib.HttpRequest} using the variants' ETag values.
