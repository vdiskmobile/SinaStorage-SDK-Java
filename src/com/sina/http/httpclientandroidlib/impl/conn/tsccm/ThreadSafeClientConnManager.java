 ...
 *
 */
package com.sina.http.httpclientandroidlib.impl.conn.tsccm;
...
import com.sina.http.httpclientandroidlib.conn.ConnectionPoolTimeoutException;
import com.sina.http.httpclientandroidlib.conn.ManagedClientConnection;
import com.sina.http.httpclientandroidlib.conn.params.ConnPerRouteBean;
...
import com.sina.http.httpclientandroidlib.impl.conn.DefaultClientConnectionOperator;
...
/**
 * Manages a pool of {@link com.sina.http.httpclientandroidlib.conn.OperatedClientConnection }
 ...
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link com.sina.http.httpclientandroidlib.impl.conn.PoolingHttpClientConnectionManager}
 */
@ThreadSafe
@Deprecated
