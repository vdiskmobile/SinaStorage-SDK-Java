...
public class HttpCoreContext implements HttpContext {
    ...
    /**
     * Attribute name of a {@link com.sina.http.httpclientandroidlib.HttpConnection} object that
     * represents the actual HTTP connection.
     */
    public static final String HTTP_CONNECTION  = "http.connection";

    /**
     * Attribute name of a {@link com.sina.http.httpclientandroidlib.HttpRequest} object that
     * represents the actual HTTP request.
     */
    public static final String HTTP_REQUEST     = "http.request";

    /**
     * Attribute name of a {@link com.sina.http.httpclientandroidlib.HttpResponse} object that
     * represents the actual HTTP response.
     */
    public static final String HTTP_RESPONSE    = "http.response";

    /**
     * Attribute name of a {@link com.sina.http.httpclientandroidlib.HttpHost} object that
