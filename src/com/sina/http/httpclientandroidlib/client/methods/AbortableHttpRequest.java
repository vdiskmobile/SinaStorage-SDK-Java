...
package com.sina.http.httpclientandroidlib.client.methods;

import java.io.IOException;

import com.sina.http.httpclientandroidlib.conn.ClientConnectionRequest;
import com.sina.http.httpclientandroidlib.conn.ConnectionReleaseTrigger;
...
public interface AbortableHttpRequest {
    ...
    /**
     * Sets the {@link com.sina.http.httpclientandroidlib.conn.ClientConnectionRequest}
     ...
     *
     * @see com.sina.http.httpclientandroidlib.conn.ClientConnectionManager
     */
     ...
     *   {@link com.sina.http.httpclientandroidlib.conn.ManagedClientConnection} itself.
     * If the request is already aborted, throws an {@link IOException}.
     */
     ...
     *
     * @see com.sina.http.httpclientandroidlib.client.HttpClient#execute(HttpUriRequest)
     * @see com.sina.http.httpclientandroidlib.client.HttpClient#execute(com.sina.http.httpclientandroidlib.HttpHost,
     *      com.sina.http.httpclientandroidlib.HttpRequest)
     * @see com.sina.http.httpclientandroidlib.client.HttpClient#execute(HttpUriRequest,
     *      ch.boye.httpclientandroidlib.protocol.HttpContext)
     * @see com.sina.http.httpclientandroidlib.client.HttpClient#execute(com.sina.http.httpclientandroidlib.HttpHost,
     *      com.sina.http.httpclientandroidlib.HttpRequest, ch.boye.httpclientandroidlib.protocol.HttpContext)
     */
    void abort();
