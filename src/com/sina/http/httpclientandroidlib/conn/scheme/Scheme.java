 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.sina.http.httpclientandroidlib.conn.SchemePortResolver} for default port
 * resolution and {@link com.sina.http.httpclientandroidlib.config.Registry} for socket factory lookups.
 */
@Immutable
@Deprecated
