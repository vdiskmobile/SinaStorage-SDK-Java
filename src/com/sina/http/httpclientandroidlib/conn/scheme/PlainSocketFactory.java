 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.sina.http.httpclientandroidlib.conn.socket.PlainConnectionSocketFactory}
 */
@Immutable
@Deprecated
public class PlainSocketFactory implements SocketFactory, SchemeSocketFactory {
    ...
    /**
     * @deprecated (4.1) use {@link com.sina.http.httpclientandroidlib.conn.DnsResolver}
     */
    @Deprecated
