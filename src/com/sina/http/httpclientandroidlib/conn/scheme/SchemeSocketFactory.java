...
package com.sina.http.httpclientandroidlib.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link com.sina.http.httpclientandroidlib.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p/>
     * Please note that {@link com.sina.http.httpclientandroidlib.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link com.sina.http.httpclientandroidlib.HttpHost} value used to resolve the address. The use of
     * {@link com.sina.http.httpclientandroidlib.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see com.sina.http.httpclientandroidlib.conn.HttpInetSocketAddress
     */
