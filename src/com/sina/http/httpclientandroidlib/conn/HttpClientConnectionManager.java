 ...
 *
 */
package com.sina.http.httpclientandroidlib.conn;
...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(com.sina.http.httpclientandroidlib.HttpClientConnection,
     *   com.sina.http.httpclientandroidlib.conn.routing.HttpRoute, int,
     *   com.sina.http.httpclientandroidlib.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(com.sina.http.httpclientandroidlib.HttpClientConnection,
     *   com.sina.http.httpclientandroidlib.conn.routing.HttpRoute,
     *   com.sina.http.httpclientandroidlib.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  com.sina.http.httpclientandroidlib.HttpClientConnection,
     *  com.sina.http.httpclientandroidlib.conn.routing.HttpRoute,
     *  com.sina.http.httpclientandroidlib.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     *
